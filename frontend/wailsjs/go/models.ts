...
export namespace main {
  ...
  export class EnhancedPersonInfo {
    id: string;
    title: string;
    birthday: string;
    gender: string;
    ...
    constructor(source: any = {}) {
      ...
      this.gender = source["gender"];
      this.father = this.convertValues(source["father"], NameID);
      this.mother = this.convertValues(source["mother"], NameID);
      this.spouse = source["spouse"];
      this.friends = source["friends"];
      this.colleagues = source["colleagues"];
      this.familiar = source["familiar"];
  ...
  export class SearchResult {
    ...
    constructor(source: any = {}) {
      if ("string" === typeof source) source = JSON.parse(source);
      this.persons = this.convertValues(source["persons"], EnhancedPersonInfo);
