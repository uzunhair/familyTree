...
function App() {
  ...
  return (
    <div id="App">
      <div className="icewall px-5 sm:px-8 py-5 relative after:content-[''] after:bg-gradient-to-b after:from-theme-1 after:to-theme-2 dark:after:from-darkmode-800 dark:after:to-darkmode-800 after:fixed after:inset-0 after:z-[-2]">
        {/* BEGIN: Mobile Menu */}
                ...
                <div className="simplebar-offset" style={{ right: 0, bottom: 0 }}>
                  ...
                  >
                    <div className="simplebar-content" style={{ padding: 0 }}>
                      <div className="fixed top-0 right-0 mt-4 mr-4 transition-opacity duration-200 ease-in-out invisible opacity-0 group-[.mobile-menu--active]:visible group-[.mobile-menu--active]:opacity-100">
                        <svg
                          ...
                          <ul className="menu__sub-open">
                            <li>
                              <div className="menu">
                                ...
                                <div className="menu__title">Список людей</div>
                              </div>
                            </li>
                            <li>
                              <div className="menu menu--active">
        ...
        <div className="top-bar-boxed relative z-[51] -mx-5 mb-12 mt-12 h-[70px] border-b border-white/[0.08] px-3 sm:-mx-8 sm:px-8 md:-mt-5 md:pt-0">
          <div className="flex h-full items-center">
            ...
            <div className="intro-x relative mr-3 sm:mr-6">
              ...
              <div className="relative text-white/70 sm:hidden">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={24}
                  height={24}
            ...
            {/* END: Search */}
            {/* BEGIN: Notifications */}
            <div data-tw-placement="bottom-end" className="dropdown relative intro-x mr-4 sm:mr-6">
              <div
            ...
            <div data-tw-placement="bottom-end" className="dropdown relative">
              ...
              <div
                ...
                style={{ display: "none" }}
              >
                <div className="dropdown-content rounded-md border-transparent p-2 shadow-[0px_3px_10px_#00000017] dark:border-transparent dark:bg-darkmode-600 relative mt-px w-56 bg-theme-1/80 text-white before:absolute before:inset-0 before:z-[-1] before:block before:rounded-md before:bg-black">
                  ...
                  <div className="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item hover:bg-white/5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={24}
                      height={24}
          ...
          <div className="wrapper-box bg-gradient-to-b from-theme-1 to-theme-2 flex rounded-[1.3rem] -mt-[7px] md:mt-0 dark:from-darkmode-400 dark:to-darkmode-400 translate-y-[35px] before:block before:absolute before:inset-0 before:bg-black/[0.15] before:rounded-[1.3rem] before:z-[-1]">
            ...
            <div className="md:max-w-auto min-h-screen min-w-0 max-w-full flex-1 rounded-[1.3rem] bg-slate-100 px-4 pb-10 shadow-sm before:block before:h-px before:w-full before:content-[''] dark:bg-darkmode-700 md:px-[22px]">
              ...
              <div className="mt-5 grid grid-cols-12 gap-6">
                <div className="intro-y col-span-12 lg:col-span-6"></div>
              </div>
            </div>
            {/* END: Content */}
          </div>
